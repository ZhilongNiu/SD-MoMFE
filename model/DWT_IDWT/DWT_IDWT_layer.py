...
from model.DWT_IDWT.DWT_IDWT_Functions import *
import pywt #小波的包
...
class DWT_1D(Module):
    ...
    def get_matrix(self,device):
        ...
        if torch.cuda.is_available():
            self.matrix_low = torch.Tensor(matrix_h).cuda(device)
            self.matrix_high = torch.Tensor(matrix_g).cuda(device)
        else:
...
class IDWT_1D(Module):
    ...
    def forward(self, L, H):
        ...
        self.get_matrix(device=L.device)
...
class DWT_2D_tiny(Module):
    ...
    def get_matrix(self,device):
        ...
        if torch.cuda.is_available():
            self.matrix_low_0 = torch.Tensor(matrix_h_0).cuda(device)
            self.matrix_low_1 = torch.Tensor(matrix_h_1).cuda(device)
            self.matrix_high_0 = torch.Tensor(matrix_g_0).cuda(device)
            self.matrix_high_1 = torch.Tensor(matrix_g_1).cuda(device)
        else:
...
class IDWT_2D(Module):
    ...
    def forward(self, LL, LH, HL, HH):
        ...
        self.get_matrix(device=LL.device)
...
#             self.matrix_low_0 = torch.Tensor(matrix_h_0).cuda(device)
#             self.matrix_low_1 = torch.Tensor(matrix_h_1).cuda(device)
#             self.matrix_low_2 = torch.Tensor(matrix_h_2).cuda(device)
#             self.matrix_high_0 = torch.Tensor(matrix_g_0).cuda(device)
#             self.matrix_high_1 = torch.Tensor(matrix_g_1).cuda(device)
#             self.matrix_high_2 = torch.Tensor(matrix_g_2).cuda(device)
#         else:
#             self.matrix_low_0 = torch.Tensor(matrix_h_0)
#             self.matrix_low_1 = torch.Tensor(matrix_h_1)
